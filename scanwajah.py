        ...
        if os.path.isdir(folder_path):
            ...
            for image_name in os.listdir(folder_path):
                ...
                for (x, y, w, h) in faces_detected:
                    # Resize wajah yang terdeteksi untuk digunakan dalam pelatihan
...
faces, labels, label_names = get_images_and_labels(main_path)
...
if len(faces) == 0:
    ...
    exit()
if len(set(labels)) < 2:
    print("Dataset harus memiliki setidaknya dua kelas wajah yang berbeda.")
    exit()
...
try:
    while True:
        ...
        for (x, y, w, h) in faces_detected:
            # Resize wajah yang terdeteksi dan bentuk datar untuk prediksi
            ...
            # Jika confidence terlalu rendah, beri label Unknown
            if confidence < 0.7:
                name = "Unknown"
